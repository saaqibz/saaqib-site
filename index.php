...
<body>
  ...
  <div id='impress'>
	...
	<div class='step' data-rotate-x='-50' data-rotate-z='30' data-x='30' data-y='700' data-z='-200' data-rotate-y='35'>
	  <?php require "projects.php"; ?>
	</div>
	<div class='step' data-x='790' data-y='0' data-rotate-z='-90' data-scale='0.35' data-rotate-y='35'>
	  <?php require "resume.php"; ?>
	</div>
    <div class='step' data-x='75' data-y='-670' data-z='50' data-rotate='-45' data-rotate-x='-30'>
